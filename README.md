...
I already have the  mechanical and electronic components needed to make the car run, which is the motor, wheels, axle rod, and battery. The motor will be connected by wires to the battery holders which requires AA batteries and then the wheels are connected to the thin axle rod.



This chassis piece was designed using Onshape to provide the rigid body needed to form the F1 car's shape.



I created the exact mounting points and alignment required to connect the motor, the axle rod (drivetrain), and eventually the battery into a single, cohesive, working vehicle.
...
<img width="1814" height="1102" alt="image" src="https://github.com/user-attachments/assets/a3f2ffae-231a-45b4-99d2-01b94fe5a46b" />
